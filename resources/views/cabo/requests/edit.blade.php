...
<form action="{{ route('cabo.requests.update', $materialRequest->id) }}" method="POST" class="card" id="formSolicitacaoCaboEdit">
    @csrf
    @method('PUT')
        ...
        <div class="form-grid form-grid-order-top">
            <div class="form-group">
                ...
                <input
                    ...
                    value="{{ $materialRequest->route->name ?? '-' }}"
                    readonly
                >
            </div>
            ...
            <div class="form-group">
                <label class="form-label">Rota vinculada</label>
                <input
                    type="text"
                    class="form-control-custom"
                    value="{{ $materialRequest->route->name ?? '-' }}"
