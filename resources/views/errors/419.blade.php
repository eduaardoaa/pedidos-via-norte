...
<body>
    <div class="card">
        <div class="badge">Sessão expirada</div>
        ...
        <p>
            Sua sessão ficou inativa por muito tempo ou o token expirou.<br>
            Clique abaixo para entrar novamente e continuar.
        </p>
