...
@section('title', 'Dashboard do Supervisor - Vianorte')
@section('pageTitle', 'Painel')
@section('pageDescription', 'Acompanhe suas solicitações de materiais do almoxarifado.')
...
<div class="page-head">
    <div>
        ...
        <p>Acompanhe suas solicitações e envie novos pedidos de materiais do almoxarifado.</p>
    </div>
...
<div class="card dashboard-table-card" style="margin-top:16px;">
    <div class="card-header">
        <div>
            ...
            <div class="card-subtitle">Histórico recente das suas solicitações de materiais do almoxarifado</div>
        </div>

        <div class="actions-inline">
            <a href="{{ route('supervisor.requests.index') }}" class="btn btn-green">
